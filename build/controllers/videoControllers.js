      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 3:
            ...
            req.user.save();
            res.redirect(_routes["default"].videoDetail(newVideo.id)); //324393 = 임시 ID
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          ...
          case 8:
            ...
            res.redirect(_routes["default"].home); //잘못된 주소 입력되면 홈페이지로 이동시킴
